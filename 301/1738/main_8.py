...
if __name__ == "__main__":
    ...
    """
    r = requests.post("http://0.0.0.0:5050/api/v1/cities/{}/places/".format(city_id), data={ 'user_id': user_id, 'name': "NewPlace", 'number_rooms': 4, 'number_bathrooms': 3, 'max_guest': 6, 'price_by_night': 100, 'latitude': 1.3, 'longitude': 2.3 }, headers={ 'Content-Type': "application/x-www-form-urlencoded" })
    print(r.status_code)