...
if __name__ == "__main__":
    ...
    """
    r = requests.post("http://0.0.0.0:5050/api/v1/places/{}/reviews/".format(place_id), data={ 'user_id': user_id, 'text': "NewReview" }, headers={ 'Content-Type': "application/x-www-form-urlencoded" })
    print(r.status_code)
