...
if __name__ == "__main__":
    ...
    """
    r = requests.post("http://0.0.0.0:5050/api/v1/places/{}/reviews/".format(place_id), data=json.dumps({ 'fake_user_id': user_id, 'text': "NewReview" }), headers={ 'Content-Type': "application/json" })
    print(r.status_code)